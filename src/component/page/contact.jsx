  ...
  return (
    ...
    >
      ...
      >
        <div>
          <a
            href="mailto:zakikhanchouche7@gmail.com"
        ...
        <div className="flex flex-row gap-4 mt-4">
          <a
            href="https://www.instagram.com/v_zaki_/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Instagram className="rotate-6" />
          </a>
          <a
            href="https://github.com/zaki-power/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Github />
          ...
          <a
            href="https://www.linkedin.com/in/zaki-kh-08118b333/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Linkedin />
