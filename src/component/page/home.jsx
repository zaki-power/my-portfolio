  ...
  return (
    ...
    >  
      <div className="flex flex-col justify-center pt-25 gap-5 text-white">
        ...
        />
        <div>
          <ShinyText text={t("home.intro")} disabled={false} speed={3} className='text-2xl text-[#948979]' />
          <div className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-[#222831]">{t("home.name")}</div>
        </div>

        <div className="text-sm md:text-xl lg:text-2xl text-[#948979] w-3/4">
          {t("home.description")}
        </div>
